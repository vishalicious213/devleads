      ...
      html: `
        ...
        contactDetails.contactValue
          ...
          <div style="background-color: #e8f4f8; padding: 20px; border-radius: 6px; text-align: center; margin-bottom: 25px; border-left: 5px solid #3498db;">
            ...
            <a href="#" style="display: inline-block; background-color: #3498db; color: white !important; padding: 12px 24px; border-radius: 4px; text-decoration: none !important; font-weight: 600; font-size: 16px;">Schedule Consultation</a>
          </div>
          ...
          <div style="margin-top: 25px; padding-left: 15px; border-left: 5px solid #4ecdc4; background-color: white; padding: 15px; border-radius: 6px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <p style="margin: 10px 0 0; font-size: 14px; color: #7f8c8d !important;">
              If you have any questions, please reply to this email or contact us at <a href="mailto:vishalicious213@gmail.com" style="color: #3498db !important; text-decoration: none !important;">sam@devmansam.net</a>.
            </p>
          </div>
          
          <div style="margin-top: 25px; text-align: center; color: #7f8c8d !important; font-size: 12px;">
            <p>© ${new Date().getFullYear()} Iconic Web Studios. All rights reserved.</p>
