...
![Sign up](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_Atlas_signup.png)

3. **Create a new project** (e.g., "DevLeads")

![Click project](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_new_project.png)

![New project](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_new_project_button.png)

![Choose project name](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_project_name.png)

![Member Access](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_create_project.png)

4. **Build a database** → Choose **M0 Sandbox** (free tier)

![Create a cluster](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_create_a_cluster.png)

![Deploy your cluster](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_deploy_a_cluster1.png)

5. **Select a cloud provider and region** (closest to your users)

![Select cloud provider](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_deploy_your_cluster2.png)

6. **Create cluster** (this takes 1-3 minutes)

### Step 2: Get Connection String

![Choose connection method](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_connect_to_cluster.png)

1. **Go to Clusters** → **Connect**
2. **Choose "Connect your application"**
3. **Driver**: Node.js, **Version**: 4.1 or later

![Choose node](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_connect_to_cluster2.png)

4. **Copy the connection string**:

![Copy connection string](/dashboard/assets/devleads_setup_images/mongodb/MongoDB_connect_to_cluster3.png)
...
5. **Replace `<password>` with your actual password**
   ```
   mongodb+srv://username:yourpassword@cluster.mongodb.net/
   ```
...
![Database access](<../dashboard/assets/devleads_setup_images/mongodb/MongoDB_Database Access.png>)

2. **Add New Database User**:

![Add new database user](../dashboard/assets/devleads_setup_images/mongodb/MongoDB_add_new_database_user.png)

- Username: Choose a username (e.g., `devleads-user`)
- Password: Generate a secure password (save this you will need it soon)

![Add new database user 2](../dashboard/assets/devleads_setup_images/mongodb/MongoDB_add_new_database_user2.png)

- Database User Privileges: **Read and write to any database**

![Add new database user 3](../dashboard/assets/devleads_setup_images/mongodb/MongoDB_add_new_database_user3.png)
...
![a](../dashboard/assets/devleads_setup_images/firebase/firebase_generate_key3.png)
