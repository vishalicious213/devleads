...
- **Last Contact**: When you last spoke with them (keep this updated)
...
- **Payment Actions**: Add, edit, and delete payments 
...
- **Document Actions**: View, edit, and delete forms 
...
- **File Upload**: Upload and keep track of signed contracts and other important documents
...
- **Your Notes**: Private project notes 
...
- **File Management**: Upload and keep track of PDF documents
...
- **Edit/Delete**: Modify or remove payments as needed 
...
- **Paid Amount**: Automatically calculated from all payment records 
- **Remaining Balance**: Automatically calculated (Billed Amount - Paid Amount) 
...
- **Secure Storage**: Protected document API endpoints
...
- **Agreements**: Ongoing services
- **Other**: Miscellaneous forms, guides, and client outreach scripts
...
**Uploading Documents**:
- Navigate to a specific lead information window in main dashboard
- Go to "Forms & Documents" tab
...
- **other** - Reference materials, guides, client outreach scripts, and miscellaneous forms
...
1. **Creating a Template**:
   ...
   - Reference Guide in Other Forms category
   - Click "Create Form"
...
- **Contact Tracking**: Status tracking 
...
#### Integration Options
- **Business Finder**: Native automated business data collection
- **Import/Export**: 
...
4. Wait for completion (usually 2-10 minutes depending on number of businesses you are searching for)
...
3. **Convert to Leads**: Click "Convert to Lead" to escalate successfully converted leads to main Dashboard 
...
- **Use City, State or Zip Code**: "Denver, CO", or 80110, works better than just "Colorado"
...
- **Customization**:  Replace placeholder values with your business details
