# DevLeads - Professional Lead and Project Management 
...
- Document management with PDF import/export
...
- Customizable pre-built business form templates
- Ability to create your own custom forms

### Financial Tracking
- Monitor project payments and balances
- Revenue analytics and financial reporting
- Individual payment notes
...
- Native Business Finder Tool for automated lead generation
...
- **Firebase Auth** - User authentication, authorization, and management
...
-<small> must give proper attribution to developer (devmansam777) and link to original github repository</small>** 
- **Private use allowed**
